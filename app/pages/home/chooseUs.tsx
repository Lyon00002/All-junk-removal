...
export default function ChooseUs() {
    return (
        <main className="min-h-screen w-full flex items-start justify-center px-4">
            ...
            <div className="relative w-[1440px] max-w-full min-h-[900px] overflow-visible ">
                ...
                <div className="relative z-10 mx-auto w-full max-w-7xl px-4 py-16 sm:py-20 md:py-24 flex flex-col items-center text-center text-secondary">
                    <motion.h3
                        className="font-semibold leading-tight tracking-tight text-3xl sm:text-4l md:text-5xl"
